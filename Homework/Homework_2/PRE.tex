...
\usepackage[]{amsthm} %lets us use \begin{proof}
	...
	\textbf{Perform the following tasks}
	...
	\begin{enumerate}
		...
		\textbf{Hint} Under $H_0$, the rank $R_i$ of $X_i$ is equally likely to be any one of the possible values $1,2,\dots,m+n$.
		...
		\textbf{Note} To check if your function is returning the correct value, the R function
	...
	\]
		...
		\textbf{Note} maybe write a loop in R or Python to compute these curves?
